...
function send(e){
    ...
    var text = document.forms.messageForm.messege.value;
    formData = 'id='+ encodeURIComponent(id) +"&text="+encodeURIComponent(text);
    var xhr = new XMLHttpRequest();

    xhr.open('POST','/api/v1/checkmessage',true);
    ...
    xhr.onreadystatechange = function(){
        ...
        if(xhr.readyState === 4 && xhr.status === 200){
            ...
            document.forms.messageForm.messege.value = '';
...
function longpoll(){
    ...
    dhr.open('POST','/api/v1/checkmessage',true);
